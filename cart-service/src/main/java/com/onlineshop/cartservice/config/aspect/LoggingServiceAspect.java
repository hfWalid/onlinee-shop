package com.onlineshop.cartservice.config.aspect;
...
public class LoggingServiceAspect {
    ...
    @Before("execution(* com.onlineshop.cartservice.service.*.*(..))")
    ...
    @After("execution(* com.onlineshop.cartservice.service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.onlineshop.cartservice.service.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.onlineshop.cartservice.service.*.*(..))", throwing = "exception")
